      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-white dark:text-white max-w-sm mx-auto md:mx-0">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#features" className="text-white dark:text-gray-400 hover:text-sky-600">Features</Link></li>
              <li><Link href="#how-it-works" className="text-white dark:text-gray-400 hover:text-sky-600">How It Works</Link></li>
              <li><Link href="#gallery" className="text-white dark:text-gray-400 hover:text-sky-600">Inspiration</Link></li>
              <li><Link href="#waitlist" className="text-white dark:text-gray-400 hover:text-sky-600">Join Waitlist</Link></li>
            </ul>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            {/* <div className="flex justify-center md:justify-start gap-4 text-xl text-gray-600 dark:text-gray-400">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 pt-6 border-t border-gray-100 dark:border-gray-800 text-center text-sm text-white dark:text-gray-400">
